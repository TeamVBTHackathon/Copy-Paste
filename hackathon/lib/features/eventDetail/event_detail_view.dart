    ...
    IconButton(
      icon:Icon(favorite==false ?Icons.favorite_outline:Icons.favorite,color: redTheme.primaryColor,size: 35,),onPressed: ()=>setState(() {
        favorite=!favorite;
            ...
            //Top Container finished
        
           //About Content starting
           Container(
